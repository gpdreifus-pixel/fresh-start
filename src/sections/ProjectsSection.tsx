        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4 sm:mb-6 md:mb-8">
          <div className="flex items-baseline gap-4 sm:gap-6">
            ...
            <div className="flex flex-col">
              <span
                className="text-[#D7E2EA] font-light uppercase tracking-widest text-xs sm:text-sm opacity-60"
              >
                {project.category}
              </span>
              <span
        ...
        <div className="flex gap-3 sm:gap-4">
          ...
          <div style={{ width: '60%' }}>
            <img
              ...
              alt={project.name}
              className="w-full object-cover rounded-[40px] sm:rounded-[50px] md:rounded-[60px]"
              style={{ height: 'calc(clamp(130px, 16vw, 230px) + clamp(160px, 22vw, 340px) + 12px)' }}
            />
          </div>
        </div>
      </motion.div>
